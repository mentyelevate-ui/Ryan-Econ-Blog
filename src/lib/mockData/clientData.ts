...
const martinHoldings: Holding[] = [
    // ── CORE INDEX ──
    {
        ...
        assetClass: "Equities", currentPrice: 615.19, costBasis: 585.00, shares: 30,
        roi: 5.16, ytd: 0.42, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 30.95, costBasis: 29.50, shares: 500,
        roi: 4.92, ytd: 0.31, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 168.50, costBasis: 162.00, shares: 25,
        roi: 4.01, ytd: 0.78, riskProfile: "Moderate",
    ...
    // ── BLUE CHIPS ──
    {
        ...
        assetClass: "Equities", currentPrice: 252.30, costBasis: 238.00, shares: 20,
        roi: 6.01, ytd: 0.55, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 401.19, costBasis: 382.00, shares: 12,
        roi: 5.02, ytd: 0.83, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 309.41, costBasis: 295.00, shares: 15,
        roi: 4.88, ytd: 0.69, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 161.50, costBasis: 154.00, shares: 20,
        roi: 4.87, ytd: 0.35, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 172.80, costBasis: 165.00, shares: 18,
        roi: 4.73, ytd: 0.63, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 925.00, costBasis: 885.00, shares: 5,
        roi: 4.52, ytd: 0.62, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 310.11, costBasis: 298.00, shares: 10,
        roi: 4.06, ytd: 0.73, riskProfile: "Moderate",
    ...
    // ── REITs ──
    {
        ...
        assetClass: "Commercial RE", currentPrice: 65.09, costBasis: 61.50, shares: 60,
        roi: 5.84, ytd: 0.66, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Commercial RE", currentPrice: 185.07, costBasis: 176.00, shares: 12,
        roi: 5.15, ytd: 0.61, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Commercial RE", currentPrice: 133.00, costBasis: 126.50, shares: 15,
        roi: 5.14, ytd: 0.58, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Commercial RE", currentPrice: 91.50, costBasis: 87.00, shares: 30,
        roi: 5.17, ytd: 0.42, riskProfile: "Low",
    ...
    // ── BONDS & ALTS ──
    {
        ...
        assetClass: "Alternatives", currentPrice: 73.98, costBasis: 72.80, shares: 50,
        roi: 1.62, ytd: 0.26, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Alternatives", currentPrice: 49.80, costBasis: 49.10, shares: 40,
        roi: 1.43, ytd: 0.15, riskProfile: "Low",
        investmentThesis: "Inflation hedge. Childcare and housing costs rise faster than CPI.",
        entryDate: "2026-03-01", targetPrice: null,
    },
    {
        id: "m17", ticker: "GLD", name: "SPDR Gold Shares",
        assetClass: "Alternatives", currentPrice: 285.00, costBasis: 268.00, shares: 5,
        roi: 6.34, ytd: 0.69, riskProfile: "Low",
    ...
    // ── SATELLITES ──
    {
        ...
        assetClass: "Equities", currentPrice: 286.89, costBasis: 272.00, shares: 8,
        roi: 5.47, ytd: 0.68, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 382.00, costBasis: 364.00, shares: 6,
        roi: 4.95, ytd: 0.80, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 287.57, costBasis: 275.00, shares: 8,
        roi: 4.57, ytd: 0.98, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 492.65, costBasis: 475.00, shares: 5,
        roi: 3.72, ytd: 0.37, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 195.00, costBasis: 184.00, shares: 12,
        roi: 5.98, ytd: 1.36, riskProfile: "Moderate",
...
const clarkHoldings: Holding[] = [
    // ── CORE GROWTH ──
    {
        ...
        assetClass: "Equities", currentPrice: 603.20, costBasis: 565.00, shares: 25,
        roi: 6.76, ytd: 0.56, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 235.00, costBasis: 216.00, shares: 20,
        roi: 8.80, ytd: 1.59, riskProfile: "Aggressive",
    ...
    // ── TECH CONVICTION ──
    {
        ...
        assetClass: "Equities", currentPrice: 182.95, costBasis: 165.00, shares: 40,
        roi: 10.88, ytd: 1.45, riskProfile: "Aggressive",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 617.64, costBasis: 568.00, shares: 10,
        roi: 8.74, ytd: 0.77, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 211.78, costBasis: 195.00, shares: 25,
        roi: 8.60, ytd: 0.76, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 398.98, costBasis: 362.00, shares: 12,
        roi: 10.21, ytd: 1.50, riskProfile: "Aggressive",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 309.41, costBasis: 285.00, shares: 18,
        roi: 8.56, ytd: 1.29, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 252.30, costBasis: 232.00, shares: 15,
        roi: 8.75, ytd: 0.86, riskProfile: "Moderate",
    ...
    // ── ALT MANAGERS ──
    {
        ...
        assetClass: "Alternatives", currentPrice: 112.00, costBasis: 102.00, shares: 35,
        roi: 9.80, ytd: 1.98, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Alternatives", currentPrice: 86.10, costBasis: 78.50, shares: 45,
        roi: 9.68, ytd: 2.50, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Alternatives", currentPrice: 105.00, costBasis: 95.00, shares: 30,
        roi: 10.53, ytd: 2.44, riskProfile: "High",
    ...
    // ── FINANCIALS ──
    {
        ...
        assetClass: "Equities", currentPrice: 286.89, costBasis: 268.00, shares: 12,
        roi: 7.05, ytd: 1.07, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 575.00, costBasis: 535.00, shares: 8,
        roi: 7.48, ytd: 0.99, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 508.50, costBasis: 472.00, shares: 6,
        roi: 7.73, ytd: 0.86, riskProfile: "Moderate",
    ...
    // ── REITs ──
    {
        ...
        assetClass: "Commercial RE", currentPrice: 185.07, costBasis: 172.00, shares: 15,
        roi: 7.60, ytd: 1.01, riskProfile: "Low",
    ...
    },
    {
        ...
        assetClass: "Commercial RE", currentPrice: 190.53, costBasis: 178.00, shares: 12,
        roi: 7.04, ytd: 0.51, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Commercial RE", currentPrice: 850.00, costBasis: 795.00, shares: 3,
        roi: 6.92, ytd: 0.89, riskProfile: "Moderate",
    ...
    // ── HIGH GROWTH ──
    {
        ...
        assetClass: "Equities", currentPrice: 270.00, costBasis: 252.00, shares: 10,
        roi: 7.14, ytd: 1.39, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 72.00, costBasis: 65.00, shares: 40,
        roi: 10.77, ytd: 1.56, riskProfile: "High",
    ...
    },
    {
        ...
        assetClass: "Alternatives", currentPrice: 185.00, costBasis: 165.00, shares: 15,
        roi: 12.12, ytd: 2.92, riskProfile: "Aggressive",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 820.00, costBasis: 765.00, shares: 4,
        roi: 7.19, ytd: 0.93, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 85.00, costBasis: 72.00, shares: 25,
        roi: 18.06, ytd: 2.96, riskProfile: "Aggressive",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 401.19, costBasis: 375.00, shares: 10,
        roi: 6.98, ytd: 1.03, riskProfile: "Moderate",
    ...
    },
    {
        ...
        assetClass: "Equities", currentPrice: 492.65, costBasis: 462.00, shares: 6,
        roi: 6.63, ytd: 0.61, riskProfile: "Moderate",
