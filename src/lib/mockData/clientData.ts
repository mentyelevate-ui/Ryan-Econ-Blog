...
const martinProfile: ClientProfile = {
    ...
    strategy:
        "A balanced growth strategy emphasizing low-cost index exposure and blue-chip dividend growers. We maintain a 65/20/15 split across equities, real estate, and alternatives. Annual rebalancing with tax-loss harvesting in taxable accounts.",
    crm: {
...
const clarkProfile: ClientProfile = {
    ...
    strategy:
        "Aggressive growth leveraging the Clarks' high income and dual saving capacity. Over-weight growth equities and alternative managers. 75/15/10 equity/alternatives/RE split with quarterly rebalancing. Maxing catch-up 401(k) contributions with Roth conversion ladder.",
    crm: {
...
const clarkHoldings: Holding[] = [
    ...
    },
    {
        ...
        investmentThesis: "Biggest credit platform in private markets. Athene gives them permanent capital. Down 20%+ from highs — buying the dip.",
